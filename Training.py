...
# Step 1 - Convolution
classifier.add(Conv2D(32, (5, 5), input_shape = (30, 30, 3), activation = 'relu'))
...
classifier.add(Dense(units = 43, activation = 'sigmoid'))
...
training_set = train_datagen.flow_from_directory(r"C:\Users\Mounika\PycharmProjects\Leaf_disease_ditection\Dataset\train", # relative path from working directoy
                                                 target_size = (30, 30),
                                                 batch_size = 32, class_mode = 'categorical')
valid_set = test_datagen.flow_from_directory(r"C:\Users\Mounika\PycharmProjects\Leaf_disease_ditection\Dataset\val", # relative path from working directoy
                                             target_size = (30, 30),
                                        batch_size = 32, class_mode = 'categorical')
